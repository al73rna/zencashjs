...
it('multiSign() for x-of-5 should be deterministic', function () {
  ...
  expect(serializedTx).to.equal('')
})
...
it('addressToScript should be deterministic for both P2SH and P2PKH on mainnet and testnet', function () {
  addr1_mainnet = 'zt27CUh1tqguUvQrcBNpDHtd13adRauiqLX';
  addr2_mainnet = 'znWXtfAwMMzRFe9Y5u1E8qMhrMWcKodi6KX';
  addr3_testnet = addr1_mainnet;
  addr4_mainnet = 'ztimpo6bUJk8ngMpRXf3yyhTZBMDLQrDQJD';
  addr5_testnet = addr4_mainnet;

  const blockHeight = 142091
  const blockHash = '00000001cf4e27ce1dd8028408ed0a48edd445ba388170c9468ba0d42fff3052'
  expect(zencashjs.transaction.addressToScript(addr1_mainnet, blockHeight, blockHash, '')).to.equal('a914ed3f0f01c90f41ff665570d38f070c1ee8c075fe87205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
  expect(zencashjs.transaction.addressToScript(addr1_mainnet, blockHeight, blockHash, '', false)).to.equal('a914ed3f0f01c90f41ff665570d38f070c1ee8c075fe87205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
  expect(zencashjs.transaction.addressToScript(addr2_mainnet, blockHeight, blockHash, '')).to.equal('76a9143bc25502467ba509b9fb3680148a12b89c56247088ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
  expect(zencashjs.transaction.addressToScript(addr3_testnet, blockHeight, blockHash, '', true)).to.equal('76a914ed3f0f01c90f41ff665570d38f070c1ee8c075fe88ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
  expect(zencashjs.transaction.addressToScript(addr4_mainnet, blockHeight, blockHash, '')).to.equal('a914ab523674d9f2ed5a0b300aeb072fc09801363f9f87205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
  expect(zencashjs.transaction.addressToScript(addr5_testnet, blockHeight, blockHash, '', true)).to.equal('76a914ab523674d9f2ed5a0b300aeb072fc09801363f9f88ac205230ff2fd4a08b46c9708138ba45d4ed480aed088402d81dce274ecf01000000030b2b02b4');
})
